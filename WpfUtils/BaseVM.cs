...
namespace WpfUtils
{
    ...
    public class BaseVM : INotifyPropertyChanged
    {
        ...
        {
            this.SetProperty(newValue, true, (x => { }), (x => { }), (x => true), PropertyMethods.GetName(selector));
        }
        ...
        {
            this.SetProperty(newValue, allowNull, (x => { }), (x => { }), (x => true), PropertyMethods.GetName(selector));
        }
        ...
        {
            this.SetProperty(newValue, allowNull, preceeding, (x => { }), (x => true), PropertyMethods.GetName(selector));
        }
        ...
        {
            this.SetProperty(newValue, allowNull, preceeding, following, (x => true), PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetProperty<T>((() => { }), (x => { }), (x => x), PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetProperty<T>(preceeding, (x => { }), (x => x), PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetProperty(preceeding, following, (x => x), PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetProperty(preceeding, following, modifier, PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetCommand(execute, (x => true), PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetCommand((x => execute()), (x => true), PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetCommand((x => execute()), (x => canExecute()), PropertyMethods.GetName(selector));
        }
        ...
        {
            return this.GetCommand(execute, (x => canExecute()), PropertyMethods.GetName(selector));
        }
